...
Start = 86001 #시작,끝페이지 설정~$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
End = 87000 #로딩이 다된다음 페이지를 바꿔준다 
...
while ruaz < End:
    ...
    try : 
        ...
        if(ruaz<=3 or ruaz>=135979):
            driver.find_element_by_xpath('//*[@id="contents"]/div[3]/div/ul/li[10]/a').click()
        elif(ruaz==4 or ruaz == 135978):
            driver.find_element_by_xpath('//*[@id="contents"]/div[3]/div/ul/li[11]/a').click()
        elif(ruaz==5 or ruaz==135977):
            driver.find_element_by_xpath('//*[@id="contents"]/div[3]/div/ul/li[12]/a').click()
        elif(ruaz>=6 or ruaz>=135976):
             driver.find_element_by_xpath('//*[@id="contents"]/div[3]/div/ul/li[13]/a').click()
...
with open('86001~87000.pkl', 'wb') as f: #저장할때 이름 바꿔주세요~$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
